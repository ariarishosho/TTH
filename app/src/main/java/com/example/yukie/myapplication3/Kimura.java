...
public class Kimura extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.kimuraimage);
    ...
    private void sendNotification() {
        // Intent 縺ｮ菴懈��
        Intent intent = new Intent(Kimura.this, Kimura.class);
        PendingIntent contentIntent = PendingIntent.getActivity(
                Kimura.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
